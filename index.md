...
is concerned with finding necessary and sufficient conditions for a sequence to be [graphic](http://mathworld.wolfram.com/GraphicSequence.html), existence of factors with predscribed degree sequences, design and implementation of polynomial time algorithms for finding such factors, and finding counter-examples for generalizing these theorems to hypergrpahs.
